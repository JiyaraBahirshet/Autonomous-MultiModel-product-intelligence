...
REPORT_PATH = (
    REPORT_DIR
    / "b6_3_3_exp2_gate1_validation_v001.json"
)
...
def main() -> None:
    ...
    print("=" * 72)
    print("B6.3.3 EXP2 — GATE 1 VALIDATION")
    print("=" * 72)
    ...
    print("VECTORIZER_FIT_DURING_EXP2=False")
    ...
    for gamma in GAMMAS:
        ...
        print("-" * 72)
        print(f"EXP2_GAMMA={gamma}")
        print("-" * 72)

        classifier, metrics = run_exp2_gamma(
            gamma=gamma,
            X_text_train=X_text_train,
            X_text_validation=X_text_validation_known,
            transfer_train=train_transfer,
    ...
    print("=" * 72)
    print("EXP2_VALIDATION_SELECTION")
    print("=" * 72)
    ...
    report = {
        ...
        "status": "GATE_1_PASS",
        "objective": (
            "Evaluate ABO text plus genuine aligned "
